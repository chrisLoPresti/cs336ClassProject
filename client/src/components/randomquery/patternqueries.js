...
const queries = [
  ...
  },
  {
    ...
    description:
      "Run this query to make sure bars cannot sell more beers of a specific brand than it has in its inventory. If true we will return 1, if not we will return 0. **This query will most likely time out...We have a ton of tuples. It should pass in MySQL workbench. Heroku only allows for a 30 second call until timeout.",
    req: {
      query:
