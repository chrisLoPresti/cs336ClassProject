...
const queries = [
  ...
  },
  {
    ...
    description:
      "For every two beers, b1 and b2, different bars may charge differently for b1 and b2 but b1 should either be less expensive than b2 in ALL bars or more expensive than b2 in ALL bars. If true we will return 1, if not we will return 0",
    req: {
      query:
  ...
  },
  {
    ...
    description:
      "Run this query to make sure that no bartender has more then one shift a day. If true we will return 1, if not we will return 0",
    req: {
      query:
