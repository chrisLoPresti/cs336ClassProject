      ...
      >
        <FormControl className={classes.formControl}>
          ...
          >
            ...
            <MenuItem value={"item-ascending"}>Item-Ascending</MenuItem>
            <MenuItem value={"item-descending"}>Item-Descending</MenuItem>
            <MenuItem value={"quantity-ascending"}>Quantity-Ascending</MenuItem>
            <MenuItem value={"quantity-descending"}>
              Quantity-Descending
            </MenuItem>
            <MenuItem value={"item_type-ascending"}>
              Item Type-Ascending
            </MenuItem>
            <MenuItem value={"item_type-descending"}>
              Item Type-Descending
            </MenuItem>
