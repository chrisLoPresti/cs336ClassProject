...
class CustomPaginationActionsTable extends React.Component {
  state = {
    rows: this.props.modification.SellsBeer,
    page: 0,
    rowsPerPage: 5,
    order: "ascending",
    orderBy: "barname"
  ...
  handleChange = event => {
    this.setState({
      rows:
        event.target.value === ""
          ? this.props.modification.SellsBeer
          : this.props.modification.SellsBeer.filter(
              person =>
                person.barname
                  .toLowerCase()
                  ...
                  .map((row, i) => {
                    return (
                      ...
                      >
                        ...
                        <TableCell>{row.beername}</TableCell>
