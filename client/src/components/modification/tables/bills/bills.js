...
class CustomPaginationActionsTable extends React.Component {
  state = {
    rows: this.props.modification.Bills,
    page: 0,
    rowsPerPage: 5,
    order: "ascending",
    orderBy: "drinker"
      ...
      <div id="table-container">
        <Grid container id="table-grid">
          <Grid item xs={12} style={{ textAlign: "center" }}>
            ...
            <Typography>
              Drag or scroll the graph to the right for more results. If you
              cant find what your looking for, try pressing 'Get More Data'.
            </Typography>
          </Grid>
